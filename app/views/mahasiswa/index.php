            ...
            <div class="modal-body">
                <form action="<?= BASEURL; ?>mahasiswa/tambah" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="txt" class="form-control" id="nama" placeholder="nama" name="nama">
                    </div>
                    <!-- NIM -->
                    <div class="mb-3">
                    ...
                    <!-- Jurusan -->
                    <label for="jurusan">Juusan</label>
                    <select class="form-select" aria-label="Pilih Jurusan" id="jurusan" name="jurusan">
